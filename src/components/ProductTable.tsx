...
import { columns } from "@/app/(main)/(pages)/products/columns";
...
// monthlyProfit,
DataTableProps) {
  const [selectedCard, setSelectedCard] = useState<Product>(data[0]);
  ...
  //               <CardDescription>All products from your store.</CardDescription>
  //             </CardHeader>
  //             <CardContent>
  //               <Table>
  //                 <TableHeader>
  ...
  //               <div className="text-xs text-muted-foreground">
  //                 Updated{" "}
  //                 <time dateTime={`${selectedCard.created_date}`}>
  //                   {selectedCard.created_date}
  //                 </time>
  //               </div>
