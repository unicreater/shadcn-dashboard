...
import { fetchAllAgentPolicyFromDb } from "@/utils/databaseUtils";
import AgentPolicyPageClient from "./_components/AgentPolicyPageClient";
...
async function AgentPolicyDataLoader() {
  try {
    const data: AgentPolicy[] = await fetchAllAgentPolicyFromDb();
    return <AgentPolicyPageClient initialData={data} />;
  } catch (error) {
    console.error("Error fetching AgentPolicys:", error);
...
export default function InventoryPage() {
  return (
    <Suspense fallback={<AgentPolicyLoadingSkeleton />}>
      <AgentPolicyDataLoader />
    </Suspense>
  );
}

function AgentPolicyLoadingSkeleton() {
  return (
